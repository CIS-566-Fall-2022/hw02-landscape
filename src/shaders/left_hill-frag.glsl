...
const DirectionalLight gi_light_0 = DirectionalLight(normalize(vec3(-5.0, 0, -5.0)), vec3(.31, .07, .02));
const DirectionalLight gi_light_1 = DirectionalLight(normalize(vec3(5.0, 0, -5.0)), vec3(.21, .04, .0015));
...
vec3 shadeIntersection(Intersection isect) {
  ...
  material_color = vec3(0.5,0.85,2);
